          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    ?>
                    <a class="dropdown-item" href="/getConsultaAsegNomResponse"><?= $data[0] ?></a>
            ...
            <div class="container">
                <h1 class="display-4">
                  <svg class="bi bi-wrench" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Herramientas o Librerias empleadas
                </h1>
                <hr>
                <h3>
                  ...
                  Clase SimpleXMLElement - Nativo PHP
                </h3>
                <p>
                <h3>
                  <svg class="bi bi-code-slash" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                  ...
                  Constructor de SoapClient  - Nativo PHP
                </h3>
                <p>
                <p>
                <h3>
                  ...
                  WsdlToPhp - <i style="font-size: 20px">Mikaël DELSOL</i> - Customizado (Adaptado)
                </h3>
                <p>
                <h3>
                  <svg class="bi bi-code-slash" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Conversión de estándar X12N-5010 a Objetos  - Librería propia (Carlos Gutíerrez)
                </h3>
                <p>
                <p>
                <h3>
                ...
                <h3>
                  <svg class="bi bi-book" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Kit te Integración (Documentación, manuales, librería Java)
                </h3>
                <p>
                <p>
                <h3>
                  <svg class="bi bi-book" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <path fill-rule="evenodd" d="M12.786 1.072C11.188.752 9.084.71 7.646 2.146A.5.5 0 0 0 7.5 2.5v11a.5.5 0 0 0 .854.354c.843-.844 2.115-1.059 3.47-.92 1.344.14 2.66.617 3.452 1.013A.5.5 0 0 0 16 13.5v-11a.5.5 0 0 0-.276-.447L15.5 2.5l.224-.447-.002-.001-.004-.002-.013-.006-.047-.023a12.582 12.582 0 0 0-.799-.34 12.96 12.96 0 0 0-2.073-.609zM15 2.82v9.908c-.846-.343-1.944-.672-3.074-.788-1.143-.118-2.387-.023-3.426.56V2.718c1.063-.929 2.631-.956 4.09-.664A11.956 11.956 0 0 1 15 2.82z"/>
                      ...
                      <a target="_blank" href="http://portal.susalud.gob.pe/blog/ejemplos-en-formato-x12n-5010/">PORTAL SUSALUD - EJEMPLOS EN FORMATO X12N-5010 </a> <span style="font-size: 20px"> - Pruebas Unitarias</span>
                </h3>
                <p>
                <p>
                <h3>
                  <svg class="bi bi-book" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a target="_blank" href="https://www.oasis-open.org/committees/tc_home.php?wg_abbrev=wss">OASIS Web Services Security (WSS) TC</a><span style="font-size: 20px"> - De la mano con librería WsdlToPhp</span>
                </h3>
                <p>
                <p>
                <h3>
                  <img src="{{asset('img/coffecupsilhouette_89235.png')}}" width="30" height="30">
                    Café
                </h3>
                <p>
