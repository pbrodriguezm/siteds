        ...
        <div class="accordion" id="accordionExample">
          <div class="card">
            ...
            <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
              <div class="card-body">
                        <img src="{{asset('img/soap-envelope.png')}}">
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="jumbotron jumbotron-fluid">
            <div class="container">
                ...
                <svg class="bi bi-check-circle-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Extensión de protocolo SOAP para aplicar capa de seguridad al Servicio Web
                </p>
                <p>
                <svg class="bi bi-clock-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    Aplicar estándar X12N al contenido del nodo <code><\txPeticion></code>, el cual forma parte del request y contiene parametros necesarios del método.
                </p>
            </div>
          </div>
          <div class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4">Respuesta WSDL</h1>
                <p class="lead">WS Security</p>
                <p>
                <svg class="bi bi-check-circle-fill" width="1em" height="1em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
                </svg>
                    Capturar X12N y convertir cada uno de sus elementos en objetos.
                </p>
            </div>
          </div>
          ...
          <div class="accordion" id="accordionExample22">
            <div class="card">
              <div class="card-header" id="headingOne">
                <h2 class="mb-0">
                  <button class="btn btn-link btn-block text-left" type="button" data-toggle="collapse" data-target="#accordionExample22" aria-expanded="true" aria-controls="collapseOne">
                      DIAGRAMA DE FLUJO DE TRANSACCIONES
                  </button>
                </h2>
              </div>
          
              <div id="accordionExample22" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
                <div class="card-body">
                          <img src="{{asset('img/flujo.png')}}">
                </div>
              </div>
            </div>
          </div>
