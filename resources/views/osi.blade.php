...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
      ...
      <div class="container mt-5">
          <h1>Estructura de cada método de servicio web</h1>
          <br>
          <div class="list-group ">
              <?php foreach ($aEstructura as $estructura) : ?>
                <code href="#" class="list-group-item list-group-item-action active">
                
                <p class="mb-1"><?= $estructura?></small>
                </code>
            <?php endforeach; ?>
          </div>
      </div>
